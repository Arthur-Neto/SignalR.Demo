...
using SignalR.Demo.Authorization;
using SignalR.Demo.Helpers;
using System;
...
namespace SignalR.Demo
{
    public class Program
    {
        ...
        private static void AddServices(WebApplicationBuilder builder)
        {
            ...
            string migrationsAssembly = typeof(Program).GetTypeInfo().Assembly.GetName().Name; //SignalR.Demo
        ...
        private static void ConfigureRequestPipeline(WebApplication app)
        {
            ...
            app.UseSwaggerUI(c =>
            {
                c.DocumentTitle = "Swagger UI - SignalR.Demo";
